...
#[named]
pub fn get_main_sequence_star_radius_from_mass(mass: f64) -> Result<f64, AstronomicalError> {
  trace_enter!();
  trace_var!(mass);
...
pub mod test {
  ...
  #[named]
  #[test]
  pub fn test_get_main_sequence_star_radius_from_mass() -> Result<(), AstronomicalError> {
    init();
    trace_enter!();
    // Jolly ol' Sol
    let mut mass = 1.0;
